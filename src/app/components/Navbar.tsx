...
const Navbar = () => {
    return (
        <div className="w-full px-5 py-4 flex flex-col justify-between items-center text-red-700 bg-white sm:py-2 sm:px-20 sm:flex-row drop-shadow-xl">
            <Image src="/logo-t.png" alt="" width={70} height={70} className="" />
