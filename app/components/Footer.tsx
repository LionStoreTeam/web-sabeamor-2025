        ...
        <div className="bg-nav-footer py-1 w-full flex flex-col bottom-0 items-center justify-center text-center text-white bg-red-800" >
            <div className="p-5 mb-5  flex flex-col justify-center items-center">
                <h1 className="mb-10 text-[25px] md:text-[50px] border-b-2">
                    ...
                    <br />
                    (+52) 777 - 283 - 3780</h1>
                <div className="w-87.5 h-87.5 rounded-full overflow-hidden bg-white flex items-center p-4 animate-heartbeat my-6 shadow-xl shadow-white/40">
                    <Image src="/logo-t.png" alt='' width={350} height={350} />
                </div>
                <p className="text-[20px] md:text-[25px] border-b-2 mt-2">sabeamorjamaica@gmail.com</p>
            </div>
            {/* Social Media */}
            <div className="mb-5 flex gap-5 justify-center items-center">
                <a href="https://www.facebook.com/sabeamor.mx" target="_blank" rel="noopener noreferrer">
                    <CiFacebook className="size-10 md:size-14 opacity-70 hover:opacity-100 transition-all ease-linear" />

                </a>
                <a href="https://www.instagram.com/sabeamor.mx" target="_blank" rel="noopener noreferrer">
                    <FaInstagram className="size-10 md:size-14 opacity-70 hover:opacity-100 transition-all ease-linear" />
                </a>
            </div>
